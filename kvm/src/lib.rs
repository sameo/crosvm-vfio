...
#[cfg(any(target_arch = "x86", target_arch = "x86_64"))]
macro_rules! ioapic_routing_entry {
    ($num:expr) => {
        IrqRoute {
            gsi: $num,
...
#[cfg(any(target_arch = "x86", target_arch = "x86_64"))]
macro_rules! pic_master_routing_entry {
    ($num:expr) => {
        IrqRoute {
            gsi: $num,
            source: IrqSource::Irqchip {
...
#[cfg(any(target_arch = "x86", target_arch = "x86_64"))]
macro_rules! pic_slave_routing_entry {
    ($num:expr) => {
        IrqRoute {
            gsi: $num,
            source: IrqSource::Irqchip {
...
fn kvm_default_irq_routing_table() -> Vec<IrqRoute> {
    ...
    for i in 0..8 {
        routes.push(pic_master_routing_entry!(i as u32));
        routes.push(ioapic_routing_entry!(i as u32));
    }
    for i in 8..16 {
        routes.push(pic_slave_routing_entry!(i as u32));
        routes.push(ioapic_routing_entry!(i as u32));
    }
    for i in 16..24 {
        routes.push(ioapic_routing_entry!(i as u32));
